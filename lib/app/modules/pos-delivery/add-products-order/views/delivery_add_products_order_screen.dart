...
class DeliveryAddProductsOrderScreen
    extends GetView<DeliveryAddProductsOrderScreenController> {
  const DeliveryAddProductsOrderScreen({Key? key}) : super(key: key);
  @override
